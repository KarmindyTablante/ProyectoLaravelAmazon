    ...
    ?>                       
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="{{ url('/') }}" class="brand-link">
                    <img src="{{asset('dist/img/y.png')}}" alt="TusComprasHoy Logo" class="brand-image img-circle elevation-3"
                        style="opacity: .8">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                            ...
                            <nav id="menu">
                               ...
                               <li class="nav-item">
                                  <a  href="{{url('ventas')}}" class="{{ Request::path() === '/' ? 'nav-link active' : 'nav-link' }}">
